...
public class Jawaban_Nomor3_UTS_1C {
    ...
    public static void viewAllDataApp(){
        ...
        System.out.println("\nSisa Kuota Kopi Latte Don't Be Late : " + KopiLatteData);
        System.out.println("Sisa Kuota Kopi Goncang jiwa : " + KopiGoncangJiwaData);
        System.out.println("Sisa Kuota Kopi Jalan Kenangan : " + KopiJalanKenanganData);
        System.out.println("Sisa Kuota Kopi Pahit Tanpa Rasa : " + KopiPahitTanpaRasaData);
        System.out.println("\nPenjualan Kopi Terbanyak Adalah : " + PenjualanKopiTerbanyak);
        System.out.println("Kuota Kopi Yang Tersedia adalah " + JumlahSemuaKuotaKopi + " | Kopi Yang Tersisa Dari 4 Jenis Menu adalah " + sisaKopiKenangan);
    }
